...
public class Hook {
    ...
    private static final String BROWSER_PARAM = System.getProperty("selenium.browser.param");
    private static final String GRID_PARAM = System.getProperty("selenium.grid.param");
    ...
    private void initialiseDriver() {
        final String activeDriver = getBrowser();
        // Prevent mem leak
        if (!isEmpty(driver)) {
            closeDriver();
        }
        ...
        if ("chrome".equals(activeDriver)) {
            setChromeDriver();
        } else if ("firefox".equals(activeDriver)) {
            setFirefoxDriver();
        }
